...
///
///     module.define("colors", d3.schemeBlues[9]);
...
final List<List<String>?> schemeBlues = List.filled(10, null)
  ..setRange(
      3,
      10,
      [
...
final _interpolateBlues = ramp(schemeBlues);

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from the “Blues” sequential color scheme represented as an RGB string.
///
/// <div id="obs">
///     <div id="in"></div>
///     <div id="out"></div>
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolateBlues);
///     module.define("n", 256);
...
///
/// {@category Sequential schemes}
String interpolateBlues(num t) => _interpolateBlues(t);
