...
///
///     module.define("colors", d3.schemeOranges[9]);
...
final List<List<String>?> schemeOranges = List.filled(10, null)
  ..setRange(
      3,
      10,
      [
...
final _interpolateOranges = ramp(schemeOranges);

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from the "Oranges" sequential color scheme represented as an RGB string.
///
/// <div id="obs">
///     <div id="in"></div>
///     <div id="out"></div>
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolateOranges);
///     module.define("n", 256);
...
///
/// {@category Sequential schemes}
String interpolateOranges(num t) => _interpolateOranges(t);
