...
///
///     module.define("colors", d3.schemePiYG[11]);
...
final List<List<String>?> schemePiYG = List.filled(12, null)
  ..setRange(
      3,
      12,
      [
...
final _interpolatePiYG = ramp(schemePiYG);

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from the “PiYG” diverging color scheme represented as an RGB string.
///
/// <div id="obs">
///     <div id="in"></div>
///     <div id="out"></div>
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolatePiYG);
///     module.define("n", 256);
...
///
/// {@category Diverging schemes}
String interpolatePiYG(num t) => _interpolatePiYG(t);
