...
///
///     module.define("colors", d3.schemeYlGnBu[9]);
...
final List<List<String>?> schemeYlGnBu = List.filled(10, null)
  ..setRange(
      3,
      10,
      [
...
final _interpolateYlGnBu = ramp(schemeYlGnBu);

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from the “YlGnBu” sequential color scheme represented as an RGB string.
///
/// <div id="obs">
///     <div id="in"></div>
///     <div id="out"></div>
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolateYlGnBu);
///     module.define("n", 256);
...
///
/// {@category Sequential schemes}
String interpolateYlGnBu(num t) => _interpolateYlGnBu(t);
