...
///
///     module.define("colors", d3.schemeRdPu[9]);
...
final List<List<String>?> schemeRdPu = List.filled(10, null)
  ..setRange(
      3,
      10,
      [
...
final _interpolateRdPu = ramp(schemeRdPu);
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolateRdPu);
///     module.define("n", 256);
...
///
/// {@category Sequential schemes}
String interpolateRdPu(num t) => _interpolateRdPu(t);
