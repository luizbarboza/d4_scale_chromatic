...
final _interpolateCubehelixDefault = interpolateCubehelixLong(
    Cubehelix(300, 0.5, 0.0), Cubehelix(-240, 0.5, 1.0));

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from
/// [Green’s default Cubehelix](http://www.mrao.cam.ac.uk/~dag/CUBEHELIX/)
...
///
///     module.define("color", [], () => d3.interpolateCubehelixDefault);
///     module.define("n", 256);
...
String interpolateCubehelixDefault(num t) => _interpolateCubehelixDefault(t);
