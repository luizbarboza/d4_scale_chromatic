...
///
///     module.define("colors", d3.schemeBuGn[9]);
...
final List<List<String>?> schemeBuGn = List.filled(10, null)
  ..setRange(
      3,
      10,
      [
...
final _interpolateBuGn = ramp(schemeBuGn);

/// Given a number [t] in the range \[0,1\], returns the corresponding color
/// from the “BuGn” sequential color scheme represented as an RGB string.
///
/// <div id="obs">
///     <div id="in"></div>
///     <div id="out"></div>
...
///     const inspector = new Inspector(obs.select("#out").node());
///
///     module.define("color", [], () => d3.interpolateBuGn);
///     module.define("n", 256);
...
///
/// {@category Sequential schemes}
String interpolateBuGn(num t) => _interpolateBuGn(t);
